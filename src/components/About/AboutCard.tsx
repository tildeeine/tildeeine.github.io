...
const AboutCard: React.FC<AboutCardProps> = ({ title, text, image, reverse = false }) => {
    return (
        <div className={`flex flex-col md:flex-row items-center justify-between md:my-8 bg-background md:p-6 text-left rounded-lg font-poppins ${reverse ? 'md:flex-row-reverse' : ''} w-full max-w-[350px] md:max-w-[700px] xl:max-w-[900px] mx-auto`}>
