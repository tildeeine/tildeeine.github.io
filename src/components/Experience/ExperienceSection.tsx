        ...
        <section id="experience" className="w-full">
            <div className="mx-auto md:w-4/5 mt-40">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-20">
                    <div>
                        <h2 className="text-3xl font-poppins text-primary mb-8">Work Experience</h2>
                    ...
                    <div>
                        <h2 className="text-3xl font-poppins text-primary mb-8">Education</h2>
                        ...
                        <h2 className="text-3xl font-poppins text-primary mt-12 mb-8">Volunteer Experience</h2>
